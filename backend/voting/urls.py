...
urlpatterns = [
    ...
    path("auth/mfa/request-new-code/", MFANewCodeAPIView.as_view(), name="auth-mfa-request-new-code"),
    path("auth/mfa/get-setup-token/", MFAGetSetupTokenAPIView.as_view(), name="auth-mfa-get-setup-token"),
