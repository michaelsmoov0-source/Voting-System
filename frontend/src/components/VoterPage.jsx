...
const VoterPage = () => {
  ...
  return (
    <>
      <LoadingOverlay show={isVoting} text="Submitting vote..." />
        ...
        <form className="grid gap-4" onSubmit={submitVote}>
          <label className="grid gap-2 text-sm font-medium text-slate-700">
            ...
            {isLoadingElections && (
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-500">Loading elections...</span>
              </div>
            )}
            <select
          ...
          <label className="grid gap-2 text-sm font-medium text-slate-700">
            ...
            {isLoadingCandidates && (
              <div className="flex items-center gap-2">
                <Loader size="sm" showText={false} />
                <span className="text-slate-500">Loading candidates...</span>
              </div>
            )}
            <select
              className="rounded-lg border border-slate-300 px-3 py-2"
